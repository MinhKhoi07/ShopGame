...
<div class="admin-header">
    <h1><i class="fas fa-folder-plus"></i> Thêm Category</h1>
...
<div class="form-container">
    <form method="POST" action="{{ route('admin.categories.store') }}">
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            <label for="slug" style="display: block; color: white; margin-bottom: 8px; font-weight: 600;">Slug (tự tạo nếu để trống)</label>
